...
At the end, on a new line, provide exactly one relevant URL from Wikipedia (wikipedia.org), or ESA (esa.int) where the user can learn more. Format it exactly like this:
LEARN_MORE_URL: <url>"""
